...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        public RemoteTables(DbConnection conn)
        {
            ...
            AddTable(Station = new(conn));
            AddTable(Train = new(conn));
        }
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override Reducer ToReducer(TransactionUpdate update)
        {
            ...
            {
                "AddConsumableToPlayer" => BSATNHelpers.Decode<Reducer.AddConsumableToPlayer>(encodedArgs),
                "AddItem" => BSATNHelpers.Decode<Reducer.AddItem>(encodedArgs),
                "AddStation" => BSATNHelpers.Decode<Reducer.AddStation>(encodedArgs),
                "AddStationWithMoney" => BSATNHelpers.Decode<Reducer.AddStationWithMoney>(encodedArgs),
                "Connect" => BSATNHelpers.Decode<Reducer.Connect>(encodedArgs),
                "DeleteItem" => BSATNHelpers.Decode<Reducer.DeleteItem>(encodedArgs),
                "DeleteStation" => BSATNHelpers.Decode<Reducer.DeleteStation>(encodedArgs),
                "DeleteTrain" => BSATNHelpers.Decode<Reducer.DeleteTrain>(encodedArgs),
                "Disconnect" => BSATNHelpers.Decode<Reducer.Disconnect>(encodedArgs),
                "EnterTheTrain" => BSATNHelpers.Decode<Reducer.EnterTheTrain>(encodedArgs),
                "EquipArmor" => BSATNHelpers.Decode<Reducer.EquipArmor>(encodedArgs),
                "EquipWeapon" => BSATNHelpers.Decode<Reducer.EquipWeapon>(encodedArgs),
                "LeaveTheTrain" => BSATNHelpers.Decode<Reducer.LeaveTheTrain>(encodedArgs),
                "Login" => BSATNHelpers.Decode<Reducer.Login>(encodedArgs),
                "SetConsumablesToPlayer" => BSATNHelpers.Decode<Reducer.SetConsumablesToPlayer>(encodedArgs),
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.AddConsumableToPlayer args => Reducers.InvokeAddConsumableToPlayer(eventContext, args),
                Reducer.AddItem args => Reducers.InvokeAddItem(eventContext, args),
                Reducer.AddStation args => Reducers.InvokeAddStation(eventContext, args),
                Reducer.AddStationWithMoney args => Reducers.InvokeAddStationWithMoney(eventContext, args),
                Reducer.Connect args => Reducers.InvokeConnect(eventContext, args),
                Reducer.DeleteItem args => Reducers.InvokeDeleteItem(eventContext, args),
                Reducer.DeleteStation args => Reducers.InvokeDeleteStation(eventContext, args),
                Reducer.DeleteTrain args => Reducers.InvokeDeleteTrain(eventContext, args),
                Reducer.Disconnect args => Reducers.InvokeDisconnect(eventContext, args),
                Reducer.EnterTheTrain args => Reducers.InvokeEnterTheTrain(eventContext, args),
                Reducer.EquipArmor args => Reducers.InvokeEquipArmor(eventContext, args),
                Reducer.EquipWeapon args => Reducers.InvokeEquipWeapon(eventContext, args),
                Reducer.LeaveTheTrain args => Reducers.InvokeLeaveTheTrain(eventContext, args),
                Reducer.Login args => Reducers.InvokeLogin(eventContext, args),
                Reducer.SetConsumablesToPlayer args => Reducers.InvokeSetConsumablesToPlayer(eventContext, args),
