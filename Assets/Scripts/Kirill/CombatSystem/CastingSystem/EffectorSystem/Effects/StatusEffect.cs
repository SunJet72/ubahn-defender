...
public class StatusEffect : OnOffEffectExecutor
{
    public List<UnitCharacteristics> paramsToEffect;
    protected override void TurnOnEffect(StatefulExecutor executor)
    {
        executor.GetTarget().ApplyStatusEffect(this);
    }
    protected override void TurnOffEffect(StatefulExecutor executor)
    {
        executor.GetTarget().RemoveStatusEffect(this);
    }
    /*
